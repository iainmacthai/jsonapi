...
DATA_SOURCE = "https://iainmacthai.github.io/jsonapi/working_test/test2.json"

PRODUCT_LOCATION = ['product']
PERSON_LOCATION = ['cable1', 'name']
EMAIL1_LOCATION = ['cable1', 'email', 0]
EMAIL2_LOCATION = ['cable2', 'email', 1]
HOMEPHONE_LOCATION = ['cable1', 'phones', 'home']
MOBILENUMBER_LOCATION = ['cable2', 'phones', 'mobile']
